...
CREATE TABLE `article_description` (
  ...
  `art_description` varchar(300) COLLATE utf8_bin DEFAULT NULL,
  PRIMARY KEY (`description_id`),
  UNIQUE KEY `description_id_UNIQUE` (`description_id`),
  CONSTRAINT `article_description` FOREIGN KEY (`description_id`) REFERENCES `articles` (`article_number`) ON DELETE CASCADE ON UPDATE RESTRICT
...
CREATE TABLE `articles` (
  ...
  CONSTRAINT `fk_category` FOREIGN KEY (`category`) REFERENCES `categories` (`category_id`) ON DELETE RESTRICT ON UPDATE CASCADE
...
INSERT INTO `articles` VALUES (1,10,NULL,1,20,'Gran'),(2,15,NULL,1,50,'Tall'),(3,7,NULL,2,13,'Asp'),(4,13,NULL,24,37,'burr burr'),(5,1,'https://i.imgur.com/nHcnB0S.jpg',1,30000,'fluff');
...
INSERT INTO `categories` VALUES (1,'Barrträd'),(24,'Eduardo'),(5,'Gamer-träd'),(23,'Hannis'),(2,'Lövträd'),(3,'Små träd'),(4,'Stora träd'),(7,'Träd från kända serier'),(6,'Wannabee-träd'),(21,'albin suger på riktigt'),(16,'c'),(17,'d'),(18,'hejsan'),(22,'hopp'),(11,'klokt'),(13,'oklokt'),(19,'tjosan'),(14,'väldigtoklokt');
...
-- Dump completed on 2019-11-21 16:07:35
